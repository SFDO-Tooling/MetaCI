...
-------------------------------
If you would like to populate your instance of MetaCI with test data simply 
set DJANGO_SETTINGS_MODULE to config.settings.local in the ``.env`` docker-compose.yml file. 
