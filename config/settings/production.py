...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['mrbelvedereci.herokuapp.com'])
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='mrbelvedereci <noreply@mrbelvedereci.herokuapp.com>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[mrbelvedereci] ')
...
SITE_URL = env('SITE_URL', default='https://{}.herokuapp.com'.format(HEROKU_APP_NAME))
