...
const UnwrappedDebugIcon = ({
  debugStatus,
  apiURL
}: ReduxProps) => debugStatus ? <div style={{ textAlign: 'right' }}>
      <a href={apiURL} target="_debugCodeWindow">
        <Icon assistiveText={{ label: 'debug' }} category="utility" name="cases" />
      </a>
    </div> : null;
...
const DebugIcon: ComponentType<{}> = connect(select, null)(UnwrappedDebugIcon);
