...
import type { TestMethodPerfUI, FilterDefinition } from 'api/testmethod_perf_UI_JSON_schema';
...
export const selectTestMethodPerfUI =
        (appState: AppState): TestMethodPerfUI | null =>{
                console.log(appState.perfDataUI.status,
                        appState.perfDataUI.status === "AVAILABLE" ?
                                appState.perfDataUI.uidata.testmethod_perf : null )
...
export const selectTestMethodResultsUI =
        (appState: AppState): TestMethodPerfUI | null =>
                appState.perfDataUI.status === "AVAILABLE" ?
                appState.perfDataUI.uidata.testmethod_results : null;

export const selectBuildflowFiltersUI =
        (appState: AppState): FilterDefinition[] | null =>
                appState.perfDataUI.status === "AVAILABLE" ?
                appState.perfDataUI.uidata.buildflow_filters : null;
